...
public class DynamicPlaceholderService
{
    ...
    public string GetValueAccordingToCommand(DynamicPlaceholder placeholder, string userInput)
    {
        ...
        return placeholder.Command switch
        {
            ...
            DynamicPlaceholderEnum.Date => DateTime.Now.ToShortDateString(),
            DynamicPlaceholderEnum.Time => DateTime.Now.ToShortTimeString(),

            DynamicPlaceholderEnum.Username => Environment.UserName,
            DynamicPlaceholderEnum.MachineName => Environment.MachineName,
            DynamicPlaceholderEnum.OSVersion => Environment.OSVersion.ToString(),

            DynamicPlaceholderEnum.ClipboardTop => Clipboard.GetText(),

            DynamicPlaceholderEnum.Calculate => DynamicPlaceholderHelper.CalculateStringExpression(placeholder, userInput),
            DynamicPlaceholderEnum.GUID => Guid.NewGuid().ToString(),
